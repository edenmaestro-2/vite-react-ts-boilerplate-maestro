                ...
                <div className="md:flex md:justify-between p-6">
                    <div className="mb-6 md:mb-0">
                        <Link to={"/Contact"} className="flex items-center">
                            ...
                            <span className="self-center text-white text-2xl font-semibold whitespace-nowrap dark:text-white">Voytheia</span>
                        </Link>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                ...
                                <li>
                                    <Link to={"/Contact"} className="hover:underline">Discord</Link>
                                </li>
                            </ul>
                        </div>
                        <div>
