...
var useTextToVoice = function (_a) {
    ...
    var voiceTranscript = (0, react_1.useRef)('');
    var firstRenderRef = (0, react_1.useRef)(true);
    var _c = (0, react_1.useState)(''), textContent = _c[0], setTextContent = _c[1];
    var _d = (0, react_1.useState)(false), isSpeaking = _d[0], setIsSpeaking = _d[1];
    var synth = typeof window === 'undefined' ? null : window.speechSynthesis;
    var utterThis = (0, react_1.useMemo)(function () {
        if (typeof SpeechSynthesisUtterance === 'undefined') {
            return null;
        }
        return new SpeechSynthesisUtterance(textContent);
    }, [textContent]);
    var extractText = (0, react_1.useCallback)(function (element) {
        if (!element)
            return;
    ...
    var voiceNames = (0, react_1.useMemo)(function () { return voices.map(function (voice) { return voice.name; }); }, [voices]);
...
exports["default"] = useTextToVoice;
//# sourceMappingURL=useTextToVoice.js.map